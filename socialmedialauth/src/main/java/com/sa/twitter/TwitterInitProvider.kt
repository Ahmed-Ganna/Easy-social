...
class TwitterInitProvider : ContentProvider() {
  ...
  private fun initTwitter(context: Context) {
    val consumerKey = AppUtils.getMetaDataValue(context, context.getString(R.string.com_sa_twitterConsumerKey))
    val consumerSecret = AppUtils.getMetaDataValue(context, context.getString(R.string.com_sa_twitterConsumerSecret))
