...
public class InstagramAuthActivity extends SimpleAuthActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        clientId = AppUtils.getMetaDataValue(this, getString(R.string.com_sa_instagramClientId));
        clientSecret = AppUtils.getMetaDataValue(this, getString(R.string.com_sa_instagramClientSecret));
        redirectUrl = AppUtils.getMetaDataValue(this, getString(R.string.com_sa_instagramRedirectUrl));
